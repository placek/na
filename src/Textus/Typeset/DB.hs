...
module Textus.Typeset.DB where
...
data Verse =
  Verse { verseNumber :: VerseNumber
        , words       :: [Textus.Typeset.DB.Word]
        , comments    :: [Textus.Typeset.DB.Commentary]
        , latin       :: Text
        , eusebeios   :: Int
        , references  :: Text
        } deriving (Eq, Show, Generic)
...
data Chapter =
  Chapter { chapterNumber :: ChapterNumber
          , verses        :: [Textus.Typeset.DB.Verse]
          } deriving (Eq, Show, Generic)

data Book =
  Book { bookNumber :: BookNumber
       , chapters   :: [Textus.Typeset.DB.Chapter]
       } deriving (Eq, Show, Generic)

newtype Volume = Volume { books :: [Textus.Typeset.DB.Book] } deriving (Eq, Show, Generic)

-- ToJSON instances
instance ToJSON Textus.Typeset.DB.Word
instance ToJSON Textus.Typeset.DB.Verse
instance ToJSON Textus.Typeset.DB.Chapter
instance ToJSON Textus.Typeset.DB.Book
instance ToJSON Textus.Typeset.DB.Volume
instance ToJSON Textus.Typeset.DB.Commentary
instance ToJSON Textus.Typeset.DB.Reference
